...
from tools.config import Config, PathConfig, WebDriverSettings
from tools.functions import load_file


resources_path = Path("resources")
dataset_path = Path("/home/user/test-dataset")

config = Config(
    path=PathConfig(
        resources=resources_path,
        data=dataset_path,
        html=dataset_path / "html",
        explicit=dataset_path / "explicit.jsonl",
        descriptor=dataset_path / "descriptor.jsonl",
    ),
    sub_proc_count=6,
    webdriver_settings=WebDriverSettings(
        temp_dir=Path("/mnt/hdd/tmp"),
        dotfile=Path(".driver"),
        ...
        sanitizejs=load_file(resources_path / "sanitize.js"),
        navigatorjs=load_file(resources_path / "navigator.js"),
        log_path=Path(".geckodriver.log"),
        proxies_from_conf=True,
        proxies=[
            "37.135.121.10:80",
            "104.248.90.212:80",
            "50.206.25.111:80",
